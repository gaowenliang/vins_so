...
bool
InitVio::VisaulImuAligment::VisualIMUAlignment( map< double, InitVio::ImageImuFrame >& imageFrames,
                                                ...
                                                bool solve_scale )
{
    ...
    if ( !solveGyroscopeBias( imageFrames, Bgs ) )
        return false;

    if ( solve_scale )
    {
        if ( LinearAlignmentScale( imageFrames, g, x, align_camera_index ) )
            return true;
        else
            return false;
    }
...
bool
InitVio::VisaulImuAligment::solveGyroscopeBias( map< double, InitVio::ImageImuFrame >& imageFrameAll,
                                                std::vector< Vector3d >& Bgs )
{
    Matrix3d A;
    Vector3d b;
...
bool
InitVio::VisaulImuAligment::LinearAlignmentScale( map< double, InitVio::ImageImuFrame >& imageFrameAll,
                                                  Vector3d& g,
                                                  VectorXd& x,
                                                  int camera_index )
{
    ...
    RefineGravityScale( imageFrameAll, g, x, camera_index );
    s = ( x.tail< 1 >( ) )( 0 ) / 100.0;
...
void
InitVio::VisaulImuAligment::RefineGravityScale( map< double, InitVio::ImageImuFrame >& all_image_frame,
                                                Vector3d& g,
                                                VectorXd& x_state,
                                                int align_camera_index )
{
...
bool
InitVio::VisaulImuAligment::LinearAlignment( map< double, InitVio::ImageImuFrame >& imageFrameAll,
                                             Vector3d& g,
                                             VectorXd& x,
                                             int camera_index )
{
...
void
InitVio::VisaulImuAligment::RefineGravity( map< double, InitVio::ImageImuFrame >& all_image_frame,
                                           Vector3d& g,
                                           VectorXd& x,
                                           int align_camera_index )
{
...
MatrixXd
InitVio::VisaulImuAligment::TangentBasis( Vector3d& g0 )
{
    Vector3d b, c;
