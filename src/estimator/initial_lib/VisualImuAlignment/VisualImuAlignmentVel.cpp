...
bool
InitVio::VisualImuAlignmentVel::solve( map< double, InitVio::ImageImuFrame >& imageFrames,
...
bool
InitVio::VisualImuAlignmentVel::LinearAlignment( map< double, InitVio::ImageImuFrame >& imageFrameAll,
                                                 Vector3d& g,
                                                 VectorXd& x,
                                                 int camera_index )
{
...
void
InitVio::VisualImuAlignmentVel::RefineGravity( map< double, InitVio::ImageImuFrame >& all_image_frame,
                                               Vector3d& g,
                                               VectorXd& x,
                                               int align_camera_index )
{
...
MatrixXd
InitVio::VisualImuAlignmentVel::TangentBasis( Vector3d& g0 )
{
    Vector3d b, c;
