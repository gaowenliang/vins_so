#include "vins_so/ros/ParamROS.h"
#include "vins_so/utility/ros_utility.h"

ParamROS::ParamROS( ros::NodeHandle& n ) { readParameters( n ); }

void
ParamROS::readParameters( ros::NodeHandle& n )
{
